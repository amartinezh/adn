...
describe('ProductoService', () => {
  ...
  it('should be created', () => {
    const productService: ComparendoService = TestBed.inject(ComparendoService);
    expect(productService).toBeTruthy();
  });

  it('deberia listar productos', () => {
    const dummyProductos = [
      new Comparendo('1', 'Producto 1', '','', new Date), new Comparendo('2', 'Producto 2', '','', new Date)
    ];
  ...
  it('deberia crear un producto', () => {
    const dummyProducto = new Comparendo('1', 'Producto 1', '','', new Date);
